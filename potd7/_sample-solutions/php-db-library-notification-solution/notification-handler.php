...
function getAllRecords()
{
	...
	// global $db;      // $db is in connectdb.php
...
{	
   ...
   try {
      ...
      //Recipients
      $mail->setFrom('your-username@gmail.com', 'your-name');  // setFrom(email, name-is-optional)
      $mail->addAddress($send_to_email);               // addAddress(email, name-is-optional)
   ...
   echo 'Sorry, your comment or suggestion could not be sent. Please contact <a href="mailto:your-username@gmail.com?Subject=Library Notificaiton">admin</a>';
   }
}
?>
